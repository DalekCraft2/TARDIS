...
class TARDISLazarusExtraInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        brine.setDisplayName(ChatColor.RESET + "HEROBRINE");
        ...
        golem.setDisplayName(ChatColor.RESET + "IRON_GOLEM");
        ...
        man.setDisplayName(ChatColor.RESET + "SNOW_GOLEM");
        ...
        her.setDisplayName(ChatColor.RESET + "WITHER");
        wit.setItemMeta(her);
        eggs[i] = wit;
        i++;
        // put illusioner
        ...
        usi.setDisplayName(ChatColor.RESET + "ILLUSIONER");
        ill.setItemMeta(usi);
        eggs[i] = ill;
        i++;
        ...
        if (plugin.checkTWA()) {
            ...
            ing.setDisplayName(ChatColor.RESET + "WEEPING_ANGEL");
            ...
            men.setDisplayName(ChatColor.RESET + "CYBERMAN");
            ...
            lek.setDisplayName(ChatColor.RESET + "DALEK");
            ...
            war.setDisplayName(ChatColor.RESET + "ICE_WARRIOR");
            ...
            tyc.setDisplayName(ChatColor.RESET + "EMPTY_CHILD");
            ...
            oon.setDisplayName(ChatColor.RESET + "JUDOON");
            ...
            comp.setDisplayName(ChatColor.RESET + "K9");
            ...
            eye.setDisplayName(ChatColor.RESET + "OOD");
            ...
            lent.setDisplayName(ChatColor.RESET + "SILENT");
            ...
            uri.setDisplayName(ChatColor.RESET + "SILURIAN");
            ...
            tar.setDisplayName(ChatColor.RESET + "SONTARAN");
            ...
            axs.setDisplayName(ChatColor.RESET + "STRAX");
            ...
            fane.setDisplayName(ChatColor.RESET + "TOCLAFANE");
            ...
            hta.setDisplayName(ChatColor.RESET + "VASHTA_NERADA");
            ...
            onz.setDisplayName(ChatColor.RESET + "ZYGON");
        ...
        tf.setLore(Collections.singletonList(ChatColor.GRAY + "FALSE"));
