    ...
    private ItemStack[] getItemStack() {
        ...
        for (String c : companionData) {
            if (!c.isEmpty() && i < 45) {
                ...
                skull.setDisplayName(ChatColor.RESET + op.getName());
                ArrayList<String> lore = new ArrayList<>();
                lore.add(ChatColor.GRAY + c);
                skull.setLore(lore);
        ...
        ii.setDisplayName(ChatColor.RESET + "Info");
        ArrayList<String> info_lore = new ArrayList<>();
        info_lore.add(ChatColor.GRAY + "To REMOVE a companion");
        info_lore.add(ChatColor.GRAY + "select a player head");
        info_lore.add(ChatColor.GRAY + "then click the Remove");
        info_lore.add(ChatColor.GRAY + "button (bucket).");
        info_lore.add(ChatColor.GRAY + "To ADD a companion");
        info_lore.add(ChatColor.GRAY + "click the Add button");
        info_lore.add(ChatColor.GRAY + "(nether star).");
        ii.setLore(info_lore);
        info.setItemMeta(ii);
        heads[45] = info;
        ItemStack add = new ItemStack(Material.NETHER_STAR, 1);
        ItemMeta aa = add.getItemMeta();
        aa.setDisplayName(ChatColor.RESET + "Add");
        add.setItemMeta(aa);
        heads[48] = add;
        ItemStack del = new ItemStack(Material.BUCKET, 1);
        ItemMeta dd = add.getItemMeta();
        dd.setDisplayName(ChatColor.RESET + "Remove");
        del.setItemMeta(dd);
        heads[51] = del;
        // Cancel / close
