...
public class TARDISWeatherInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        sun.setDisplayName(ChatColor.RESET + TARDISStringUtils.uppercaseFirst(plugin.getLanguage().getString("WEATHER_CLEAR")));
        ...
        ing.setDisplayName(ChatColor.RESET + TARDISStringUtils.uppercaseFirst(plugin.getLanguage().getString("WEATHER_RAIN")));
        ...
        storm.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("WEATHER_THUNDER"));
        ...
        ation.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("WEATHER_EXCITE"));
