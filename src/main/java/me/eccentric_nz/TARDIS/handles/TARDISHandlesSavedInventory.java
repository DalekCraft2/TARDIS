...
class TARDISHandlesSavedInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        bk.setDisplayName(ChatColor.RESET + "Back to editor");
        ...
        ld.setDisplayName(ChatColor.RESET + "Load selected program in editor");
        ...
        dem.setDisplayName(ChatColor.RESET + "Deactivate selected program");
        ...
        dm.setDisplayName(ChatColor.RESET + "Delete selected program");
        ...
        km.setDisplayName(ChatColor.RESET + "Check out selected program");
        ...
        cm.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_CLOSE"));
