...
class TARDISChameleonConstructorGUI {
    ...
    private ItemStack[] getItemStack() {
        ...
        bk.setDisplayName(ChatColor.RESET + plugin.getChameleonGuis().getString("BACK_CHAM_OPTS"));
        ...
        hp.setDisplayName(ChatColor.RESET + plugin.getChameleonGuis().getString("HELP"));
        ...
        List<String> lore = plugin.getChameleonGuis().getStringList("INFO_CONSTRUCT");
        ...
        at.setDisplayName(ChatColor.RESET + plugin.getChameleonGuis().getString("ABORT"));
        ...
        ld.setDisplayName(ChatColor.RESET + plugin.getChameleonGuis().getString("USE_PREV"));
        ...
        se.setDisplayName(ChatColor.RESET + plugin.getChameleonGuis().getString("SAVE"));
