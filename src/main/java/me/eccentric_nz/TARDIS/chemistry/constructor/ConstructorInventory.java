...
public class ConstructorInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        info_im.setLore(Arrays.asList(ChatColor.GRAY + "Add or subtract protons,", ChatColor.GRAY + "neutrons and electrons to", ChatColor.GRAY + "construct an atomic element."));
        ...
        pzim.setDisplayName(ChatColor.RESET + "0");
        ...
        pim.setDisplayName(ChatColor.RESET + "Protons");
        ...
        pdim.setDisplayName(ChatColor.RESET + "-");
        ...
        puim.setDisplayName(ChatColor.RESET + "+");
        ...
        nzim.setDisplayName(ChatColor.RESET + "0");
        ...
        nim.setDisplayName(ChatColor.RESET + "Neutrons");
        ...
        ndim.setDisplayName(ChatColor.RESET + "-");
        ...
        nuim.setDisplayName(ChatColor.RESET + "+");
        ...
        ezim.setDisplayName(ChatColor.RESET + "0");
        ...
        eim.setDisplayName(ChatColor.RESET + "Electrons");
        ...
        edim.setDisplayName(ChatColor.RESET + "-");
        ...
        euim.setDisplayName(ChatColor.RESET + "+");
