...
public class ReducerInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        info_im.setLore(Arrays.asList(ChatColor.GRAY + "Reduce a substance to its", ChatColor.GRAY + "component elements.", ChatColor.GRAY + "Place an item in the first slot,", ChatColor.GRAY + "then click the reduce button."));
        ...
        check_im.setDisplayName(ChatColor.RESET + "Reduce");
