...
public class TARDISMushroomBlock {
    ...
    private static final List<String> VANILLA_BROWN = Arrays.asList(
    ...
    private static final List<String> VANILLA_RED = Arrays.asList(
    ...
    private static final List<String> VANILLA_STEM = Arrays.asList(
