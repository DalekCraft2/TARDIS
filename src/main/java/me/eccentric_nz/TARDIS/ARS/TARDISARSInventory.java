...
public class TARDISARSInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        wool.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_MAP_NO"));
        ...
        load.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_MAP"));
        ...
        sim.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_RECON"));
        ...
        cobble.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_RESET"));
        ...
        nim.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_SCROLL_L"));
        ...
        pim.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_SCROLL_R"));
        ...
        tnt.setDisplayName(ChatColor.RESET + plugin.getLanguage().getString("BUTTON_JETT"));
        ...
        for (TARDISARS a : TARDISARS.values()) {
            if (a.getOffset() != 0 && i < 54) {
                ...
                im.setDisplayName(ChatColor.RESET + a.getDescriptiveName());
                List<String> lore = Collections.singletonList(ChatColor.GRAY + "Cost: " + plugin.getRoomsConfig().getInt("rooms." + a + ".cost"));
                im.setLore(lore);
